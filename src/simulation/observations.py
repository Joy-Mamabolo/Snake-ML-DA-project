...
class Observation:
    ...
    prey_list: list # list of prey objects; useful for the snake's greedyPolicy
    wall_position: set # currently not in use, but may be used when geometries become more sophisticated
